...
from backend.api import stages, tasks, board, dashboard, projects, documents, categories, contacts, companies, search, meetings
...
def _make_test_app():
    ...
    test_app.include_router(meetings.router)
